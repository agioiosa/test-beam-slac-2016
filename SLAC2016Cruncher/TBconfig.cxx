...
TBconfig::TBconfig(string &filename) {
	//
...
//
Int_t TBconfig::GetRunNumber(string &runfile){  //this function extracts the run number from the string frascatirun_xxxx.root and returns xxxx
